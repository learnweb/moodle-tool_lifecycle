...
/**
 * lifecycletrigger_customfielddelay generator tests
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class tool_lifecycle_trigger_customfielddelay_generator extends testing_module_generator {
    ...
    public static function create_trigger_with_workflow($customfieldshortname) {
        ...
        // Create trigger.
        $record = new stdClass();
        $record->subpluginname = 'customfielddelay';
        $record->instancename = 'customfielddelay';
