...
$string['config_forum'] = 'Forum für Diskussionen zu den einzelnen Workflows';
$string['config_forum_desc'] = 'Geben Sie hier die Kurs-Modul-ID des Forums für die Diskussionen zu den Workflows ein. Achten Sie auf das Vorhandensein der notwendigen Berechtigungen, damit die Lifecycle-Admins an den Diskussionen aktiv teilnehmen können.';
...
$string['course_deletions_list_header_title'] = 'Protokoll der Lifecycle-Kurslöschungen';
...
$string['discussionparticipate'] = 'Beteilige dich an der Diskussion zu diesem Workflow';
$string['discussionstart'] = 'Beginne eine Diskussion zu diesem Workflow';
...
$string['downloadcsv'] = 'Herunterladen als csv';
$string['downloadworkflow'] = 'Workflow-Definition herunterladen';
$string['downloadxlsx'] = 'Herunterladen als xlsx';
...
$string['errors_deleted_fail'] = '{$a} Fehlerdatensätze konnten nicht gelöscht werden.';
$string['errors_deleted_success'] = '{$a} Fehlerdatensätze erfolgreich gelöscht.';
...
$string['lifecycle_task'] = 'Führt Lifecycle-Prozesse aus';
$string['lifecycle_task_all'] = 'Führt alle Lifecycle Prozesse aus';
$string['lifecycle_task_wf'] = 'Führt die Prozesse von Workflow "{$a}" aus';
...
$string['numberofcoursedeletions'] = 'angezeigte Kurslöschungen';
$string['numberofmodules'] = 'Kursmodule gelöscht';
$string['numberofparticipants'] = 'Teilnehmer gelöscht';
...
$string['proceed_process_after_error_fail'] = 'Fortführen gescheitert';
$string['proceed_process_after_error_success'] = 'Erfolgreich fortgeführt';
...
$string['rollback_process_after_error_fail'] = 'Zurücksetzung gescheitert';
$string['rollback_process_after_error_success'] = 'Zurücksetzung erfolgreich';
...
$string['showcasedesc'] = 'Liste aller Workflows';
...
$string['stopped'] = 'Gestoppt';
$string['stopped_help'] = 'Gestoppt: Derzeit werden keine Kurse durch diesen Step bearbeitet.';
...
$string['switchworkflow'] = 'Gehe zu Workflow';
...
$string['workflow_showcase_header'] = 'Workflow Galerie';
$string['workflow_sortindex'] = 'Rauf/Runter';
...
$string['workflowdescriptionlink'] = 'Bitte geben Sie hier eine Workflow-Beschreibung ein';
