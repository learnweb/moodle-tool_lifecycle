...
$string['courses_candidates_alreadyin'] = ', weitere {$a} Kandidaten sind bereits in Verarbeitung oder bei den Verarbeitungsfehlern';
...
$string['coursesdelayed'] = 'Verzögerte Kurse des Workflows \'{$a->title}\' ({$a->courses})';
...
$string['coursesexcluded'] = 'Ausgeschlossene Kurse für Trigger \'{$a->title}\' ({$a->courses})';
...
$string['documentationlink'] = 'Dokumenation auf github';
...
$string['invalid_workflow_details'] = 'Erstelle mindestens einen Trigger und einen Schritt für diesen Workflow.';
