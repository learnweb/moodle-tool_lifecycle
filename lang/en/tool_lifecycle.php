...
$string['courses_candidates_alreadyin'] = ', another {$a} candidates are already part of this process or of the process errors';
...
$string['coursesdelayed'] = 'Courses delayed for workflow \'{$a->title}\' ({$a->courses})';
...
$string['coursesexcluded'] = 'Courses excluded by trigger \'{$a->title}\' ({$a->courses})';
...
$string['invalid_workflow_details'] = 'Create at least one trigger and one step for this workflow';
