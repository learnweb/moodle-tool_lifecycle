...
$string['additionalworkflowsettings'] = 'Additional workflow settings';
...
$string['config_forum'] = 'Forum for workflow discussions';
$string['config_forum_desc'] = 'Enter the course module ID of the dedicated workflow discussion forum. Make sure that lifecycle admins have the sufficient rights to participate in this forum.';
...
$string['course_deletions_list_header'] = 'Course deletions';
$string['course_deletions_list_header_title'] = 'Protocol of lifecycle course deletions';
$string['courseid'] = 'Course ID';
$string['coursename'] = 'Course name';
$string['coursenotfound'] = 'Course not found (anymore)';
...
$string['delete_all_confirmation_text'] = 'This will delete all selected entries. Are you sure?';
$string['delete_all_delays'] = 'Delete all delays';
$string['delete_delay'] = 'Delete delay';
$string['deletealldescription'] = 'course backups which had been created before the given date';
$string['deletedate'] = 'Backups created before';
$string['deletedate_help'] = 'Select the backups created before the here defined date';
...
$string['discussionparticipate'] = 'Join the discussion about this workflow.';
$string['discussionstart'] = 'Start a discussion about this workflow';
...
$string['lifecycle_task'] = 'Run life cycle processes';
$string['lifecycle_task_all'] = 'Run all life cycle processes';
$string['lifecycle_task_wf'] = 'Run processes of workflow "{$a}"';
...
$string['modules'] = 'Course Modules';
$string['move_down'] = 'Move down';
$string['move_up'] = 'Move up';
$string['name_until_date'] = '"{$a->name}" until {$a->date}';
$string['nextrun'] = 'Next run: {$a}';
$string['noactionsavailable'] = 'You cannot execute any action to handle this course.';
$string['noactiontools'] = 'No tools available';
$string['nocoursesdeleted'] = 'No deleted courses found!';
...
$string['numberofcoursedeletions'] = 'deleted courses shown';
$string['numberofmodules'] = 'deleted modules';
$string['numberofparticipants'] = 'deleted participants';
...
$string['proceed_process_after_error_fail'] = 'Proceed failed';
$string['proceed_process_after_error_success'] = 'Proceed successfull';
...
$string['restore_step_does_not_exist'] = 'The step {$a} is not installed, but is included in the backup file. Please install it first and try again.';
...
$string['restore_trigger_does_not_exist'] = 'The trigger {$a} is not installed, but is included in the backup file. Please install it first and try again.';
$string['restore_workflow_not_found'] = 'Wrong format of the backup file. The workflow could not be found.';
$string['rollback'] = 'Rollback';
$string['rollback_process_after_error_fail'] = 'Rollback failed';
$string['rollback_process_after_error_success'] = 'Rollback successfull';
...
$string['stopped_help'] = 'Whether the step processes courses at the moment or not.';
...
$string['switchworkflow'] = 'Switch workflow';
...
$string['triggeredpercron'] = 'Maximum courses triggered per cron';
$string['triggeredpercron_help'] = 'Define here the maximum of courses triggered per cron. (Only whole numbers)';
$string['triggeredpercron_overview'] = 'Maximum of {$a} course(s) triggered per cron';
$string['triggeredperday'] = 'Maximum courses triggered per day';
$string['triggeredperday_help'] = 'Define here the maximum of courses triggered per day. (Only whole numbers)';
$string['triggeredperday_overview'] = 'Maximum of {$a} course(s) triggered per day';
...
$string['workflow_was_not_imported'] = 'The workflow has not been imported.';
