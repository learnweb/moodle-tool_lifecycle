...
class process {
    ...
    /** @var string $errormessage process error message */
    public $errormessage;

    /** @var string $errortrace process error trace message */
    public $errortrace;

    /** @var /timestamp $errortimecreated Date the process was marked as error */
