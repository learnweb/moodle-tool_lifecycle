...
$string['interaction_decision_action_alt'] = 'Take Action';
$string['interaction_form_header'] = 'Opencast Step pending decision';
$string['interaction_form_option_abort'] = 'Abort';
$string['interaction_form_option_accept'] = 'Accept';
$string['interaction_form_option_confirm'] = 'Confirm';
$string['interaction_form_option_pending'] = 'Pending';
$string['interaction_form_select_decision'] = 'Your decision';
$string['interaction_form_select_decision_help'] = 'The following available decision are to select:<br>Accept: means you are agree and would like the step to proceed.<br>Abort: just abort the processing<br>Pending: Make the process still waiting for you to review it later.';
$string['interaction_give_action_decided'] = '{$a} has made a decision for this step.';
$string['interaction_state_info_aborted'] = 'This step processing has been aborted!';
$string['interaction_state_info_default'] = 'The step is currently in waiting state, how would you like to proceed?';
$string['interaction_state_info_first_spin'] = 'The step is going to process the series and videos in this course. Would you like to proceed?';
$string['interaction_state_info_rate_limiter'] = 'Rate Limiter reached, how would you like to proceed?';
$string['interaction_state_info_remove_mapping_error'] = 'Unable to remove the course series mapping for series (ID: {$a->sid}) from course (ID: {$a->cid}), how would you like to proceed?';
$string['interaction_state_info_unlink_series_error'] = 'There was a problem with removing ACLs for the series (ID: {$a}), how would you like to proceed?';
$string['interaction_state_info_workflow_error'] = 'There was a problem with starting the workflow "{$a->wf}" on event (ID: {$a->eid}), how would you like to proceed?';
$string['interaction_status_message'] = 'Opencast Step requires your attention';
$string['interaction_status_message_aborted'] = 'Opencast Step processing is aborted';
$string['interaction_status_message_completed'] = 'This step is completed.';
$string['interaction_status_message_confirm'] = 'Opencast Step is processing';
$string['interaction_status_message_processing'] = 'Opencast Step is processing';
...
$string['mform_octrace_help'] = 'When enabled, additional detailed logs will be generated.<br>Note: This setting is ignored if dry run mode is enabled.';
$string['mform_ocworkflow'] = 'Opencast workflow';
$string['mform_ocworkflow_help'] = 'The Opencast workflow that will be triggered when an event of a series is found during the step process. If no workflow is set, the Opencast instance will not be processed and will be skipped.<br>NOTE: New Opencast workflows based on tags are only retrieved after saving changes to the Opencast workflow tags.';
...
$string['opencaststep_cleanup_task'] = 'Deletes old entries from process status records.';
...
$string['report_subj'] = 'Opencast Step Process Report';
