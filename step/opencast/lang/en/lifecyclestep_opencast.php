...
$string['interaction_decision_action_alt'] = 'Run';
$string['interaction_form_header'] = 'Step Opencast - pending decision';
$string['interaction_form_option_abort'] = 'Cancel';
...
$string['interaction_form_select_decision_help'] = 'Choose one of the following options:<br>Accept: you agree to promote the process.<br>Cancel: The process is cancelled.<br>Pending: The process remains waiting.';
$string['interaction_give_action_decided'] = '{$a} has made a decision.';
$string['interaction_state_info_aborted'] = 'The step has been aborted.';
$string['interaction_state_info_default'] = 'The process is pending, how do you want to continue?';
$string['interaction_state_info_first_spin'] = 'This step will change the series and videos of this course. Do you want to continue?';
$string['interaction_state_info_rate_limiter'] = 'The rating limit has been reached. How do you want to continue?';
$string['interaction_state_info_remove_mapping_error'] = 'The course-series assignment for series (ID: {$a->sid}) in course (ID: {$a->cid}) could not be removed. How do you want to continue?';
$string['interaction_state_info_unlink_series_error'] = 'An error occurred while removing the ACLs for series (ID: {$a}). How do you want to continue?';
$string['interaction_state_info_workflow_error'] = 'BAn error occurred while starting workflow "{$a->wf}" for event (ID: {$a->eid}). How do you want to continue?';
$string['interaction_status_message'] = 'The Opencast step requires your attention.';
$string['interaction_status_message_aborted'] = 'Processing of the Opencast step was aborted.';
$string['interaction_status_message_completed'] = 'This step has been completed.';
$string['interaction_status_message_confirm'] = 'The Opencast step is to be processed.';
$string['interaction_status_message_processing'] = 'The Opencast step is being processed.';
