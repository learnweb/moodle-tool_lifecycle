...
$string['privacy:metadata:lifecyclestep_email_notified:courseid'] = 'ID of the course the notification email was sent for';
$string['privacy:metadata:lifecyclestep_email_notified:summary'] = 'Information about users who have been sent notification emails';
$string['privacy:metadata:lifecyclestep_email_notified:timemailsent'] = 'Time when the notification email was sent';
$string['privacy:metadata:lifecyclestep_email_notified:userid'] = 'ID of the user who was sent a notification email';
